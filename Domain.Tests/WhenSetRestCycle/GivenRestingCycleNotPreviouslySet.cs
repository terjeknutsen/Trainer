...
{
    public class GivenRestingCycleNotPreviouslySet : SpecsFor<Challenge>
    {
        ...
        [Test]
        public void Then_resting_cycle_changed_event_should_be_created()
        {
            SUT.Changes.First().ShouldBeType(typeof(RestingCycleChanged));
        }
    }
}
