...
{
    public class GivenNewDurationIsEqualToCurrentDuration : SpecsFor<Challenge>
    {
        ...
        {
            SUT.SetDuration(TimeSpan.FromDays(30), It.IsAny<DateTime>());
        }
        [Test]
        public void Then_duration_changed_event_should_NOT_be_created()
        {
